...
interface IResources {
    ...
    function userResourceIndexes( uint256 ,address  ) external view returns (uint256 ) ;
    ...
    function addResource( string memory encryptedData,string memory sharedKeyCopy,string memory _ownerKeys ) external  returns (bool ) ;
    function updateResource( uint256 _id,string memory _encryptedData ) external  returns (bool ) ;
    function removeResource( uint256 id,string memory _ownerKeys ) external  returns (bool ) ;
    function addAllowedAddress( uint256 id,address user,string memory sharedKeyCopy ) external  returns (bool ) ;
    function removeAllowedAddress( uint256 id,address user ) external  returns (bool ) ;
    function userOwnsResource( address user,uint256 resourceId ) external view returns (bool ) ;
    function getResource( uint256 id,address _addr ) external view returns (Resources.Resource memory resource) ;
    function getResources( address _addr ) external view returns (Resources.Resource[] memory _resources) ;
    function getPaginatedResources( address _addr,uint256 _start,uint256 _count ) external view returns (Resources.Resource[] memory _resources, uint256 _totalResources) ;
    function getOwnerKeys( address _addr ) external view returns (string memory _ownerKeys) ;
